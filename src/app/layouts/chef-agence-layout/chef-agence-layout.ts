...
export class ChefAgenceLayout {
  ...
  menuItems = [
    ...
    { label: 'Réservations clients', route: '/chef_agence/reservations', icon: 'confirmation_number' },
    { label: 'Mes Réservations', route: '/chef_agence/reservations/self', icon: 'assignment_ind' },
    //{ label: 'Gestion Colis', route: '/chef_agence/colis', icon: 'inventory_2' },
    { label: 'Personnel', route: '/chef_agence/personnels', icon: 'people' },
    //{ label: 'Annonces', route: '/chef_agence/annonces', icon: 'campaign' },
